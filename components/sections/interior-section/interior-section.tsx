  ...
  return (
    <section className={style.interiorSection}>
      ...
      <section className={style.interiorSubSection}>
        ...
        >
          <p>Yes, there are still screens. But instead of the usual MBUX (Mercedes-Benz User Experience) setup, the 12.3-inch instrument panel is housed under a cowl, reflecting the SL&#39;s sporty roots.</p>
          <p>
      ...
      <section className={style.interiorSubSection}>
        ...
        <TranslucentCard className={clsx(style.translucentCard, style.seat)}>
          <p>For the first time in the SL&#39;s history, the car has rear seats. They can supposedly accommodate occupants up to 1.5m tall, but the backrests are so upright they seem like they are canted forward.</p>
          <p>Also, strangely absent on the test unit are soft-close doors and &#39;pushers&#39; that bring the seat belts closer to the front passengers</p>
        </TranslucentCard>
